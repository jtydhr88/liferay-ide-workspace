...
import com.liferay.ide.workspace.core.util.SapphireUtil;
import com.liferay.ide.workspace.core.util.Validator;
import com.liferay.ide.workspace.service.core.model.Column;
import com.liferay.ide.workspace.service.core.model.Entity;
import com.liferay.ide.workspace.service.core.model.Relationship;
...
public class RelationshipsBindingImpl extends LayeredListPropertyBinding {
	...
	private void _refreshRelationships() {
		...
		for (Entity entity : _serviceBuilder().getEntities()) {
			...
			if ((primaryKeyColumn != null) &&
				Validator.isNotNull(SapphireUtil.getContent(primaryKeyColumn.getName()))) {
	...
	private void _removeRelationship(RelationshipObject relObject) {
		...
		if (Validator.isNull(primaryKeyName)) {
			return;
		}
